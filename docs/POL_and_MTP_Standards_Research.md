...
| VDI/VDE/NAMUR 2658 **Blatt 1** | **2022-01 (draft) = manifest 1.1.0** | `../standards/VDI-2658/` | **Critical - our build target.** read (§2, §5, §8, §9, **§12**, §13); **§10, §11 + Annex still unread** *(§12 was read at M1 step 8 - it settled the `Pea` identification fields
